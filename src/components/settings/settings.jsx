...
import withIcon from "../../assets/forusers.png";
...
const Settings = ({ data, loading, myId, fetchAccountData }) => {
  ...
  const bonus = [
    ...
    { option: "350", style: { backgroundColor: "white", textColor: "black" } },
    { option: "500", style: { backgroundColor: "#1E2C3A", textColor: "white" } },
    { option: "700", style: { backgroundColor: "white", textColor: "black" } },
    { option: "1000", style: { backgroundColor: "#1E2C3A", textColor: "white" } },
    { option: "1500", style: { backgroundColor: "white", textColor: "black" } },
    { option: "2000", style: { backgroundColor: "#1E2C3A", textColor: "white" } },
    { option: "3000", style: { backgroundColor: "white", textColor: "black" } },
  ...
  const handleUIUpdate = (btnId, dataDate, ) => {
  ...
  useEffect(() => {
    if (loading) {
      const spinBtnUpdate = () => handleUIUpdate("spin-btn", data.spin_date,);
...
<div className="balance-text-title">Bonus</div>
          {/* <hr className="line" /> */}
          <div className="setting-container">
            ...
            <button className="display-none" id="spin-btnS" >FREE SPIN </button>
          </div>
        </>
      )}
    </>
