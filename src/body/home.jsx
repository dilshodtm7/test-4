...
import Twitter from "../assets/twitter-x-icon_878233-1623.avif";
import Loaders from "../assets/forusers.png";
      ...
      {loading === false ? (
        <>
          <div className="loading-container">
                    ...
                    <h2 className="loader-title">PLAY AND EARN</h2>
                    <h3 className="loader-title" >Winnie Coin on social media</h3>
                    <div className="sotial">
                    <img src={Twitter} className="sotial-mediax" alt="" />
                    <img src={Telegram} className="sotial-media" alt="" />
                    <img src={Insta} className="sotial-media" alt="" />
                    <img src={Tiktok} className="sotial-media" alt="" />
                    <img src={Youtube} className="sotial-medias" alt="" />
                    </div>
